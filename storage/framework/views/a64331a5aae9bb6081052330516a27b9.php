<?php $__env->startSection('content'); ?>
    <div class="container mt-4">
        ...
        <div class="card-body">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($onlineMedicines->isEmpty()): ?>
            ...
            <?php else: ?>
                <div class="responsive">
                    <table class="table table-striped table-bordered" id="Table">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $onlineMedicines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medicine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="medicine-row-<?php echo e($medicine->id); ?>">
                                    <td><?php echo e($loop->iteration); ?></td>
                                    <td><?php echo e(Str::limit($medicine->generic_name, 100) ?? 'N/A'); ?></td>
                                    <td><?php echo e($medicine->brand_name ?? 'N/A'); ?></td>
                                    <td><?php echo e(Str::limit($medicine->description, 100) ?? 'N/A'); ?></td>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-success import-button"
                                            data-medicine-id="<?php echo e($medicine->id); ?>"
                                            data-medicine-name="<?php echo e($medicine->brand_name); ?>">
    ...
    <script>
        $(document).ready(function() {
            $('.import-button').on('click', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route('importStore')); ?>',
                    type: 'POST',
                    data: {
...
<?php echo $__env->make('medicines.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DEVELOPMENT\pms\resources\views/medicines/import.blade.php ENDPATH**/ ?>