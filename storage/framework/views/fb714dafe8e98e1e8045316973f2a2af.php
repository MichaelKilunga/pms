        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1 class="h3 text-primary fw-bold mb-0">Edit Package: <?php echo e($package->name); ?></h1>
                    <a class="btn btn-outline-secondary rounded-pill" href="<?php echo e(route("packages")); ?>">
                        ...
                        <form action="<?php echo e(route("packages.update", $package->id)); ?>" method="POST">
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="status" name="status">
                                        <option <?php echo e($package->status ? "selected" : ""); ?> value="1">Active</option>
                                        <option <?php echo e(!$package->status ? "selected" : ""); ?> value="0">Inactive</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" name="number_of_pharmacies" required type="number"
                                        value="<?php echo e($package->number_of_pharmacies); ?>">
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" name="number_of_pharmacists" required type="number"
                                        value="<?php echo e($package->number_of_pharmacists); ?>">
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" name="number_of_owner_accounts" required type="number"
                                        value="<?php echo e($package->number_of_owner_accounts); ?>">
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" name="number_of_admin_accounts" required type="number"
                                        value="<?php echo e($package->number_of_admin_accounts); ?>">
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" name="number_of_medicines" required type="number"
                                        value="<?php echo e($package->number_of_medicines); ?>">
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div
                                            ...
                                            <label class="form-check-label fw-bold mb-0"
                                                for="<?php echo e($field); ?>"><?php echo e($label); ?></label>
                                            <input name="<?php echo e($field); ?>" type="hidden" value="0">
                                            <input <?php echo e($package->$field ? "checked" : ""); ?>

                                                class="form-check-input ms-2 mt-0" id="<?php echo e($field); ?>"
                                                name="<?php echo e($field); ?>" role="switch" style="transform: scale(1.2);"
                            ...
                            <div class="d-flex justify-content-end mt-5">
                                <a class="btn btn-secondary rounded-pill me-2 px-4"
                                    href="<?php echo e(route("packages")); ?>">Cancel</a>
...
<?php echo $__env->make("packages.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DEVELOPMENT\pms\resources\views/packages/edit.blade.php ENDPATH**/ ?>