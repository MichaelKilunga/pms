<?php $__env->startSection('title', 'Become Agent'); ?>
<?php $__env->startSection('meta_description', 'Apply to become an agent for our Pharmacy Management System. Join our network and manage pharmacies across Tanzania.'); ?>
<?php $__env->startSection('meta_keywords', 'Become Agent, Pharmacy Agent, Pharmacy Management System, DLDM system, Online Pharmacy Tanzania'); ?>
...
<?php endif; ?>
            ...
            <div class="mt-4 hidden form-group">
                <?php if (isset($component)) { $__componentOriginald8ba2b4c22a13c55321e34443c386276 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald8ba2b4c22a13c55321e34443c386276 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.label','data' => ['for' => 'role','value' => ''.e(__('Role : Agent')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'role','value' => ''.e(__('Role : Agent')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald8ba2b4c22a13c55321e34443c386276)): ?>
<?php $attributes = $__attributesOriginald8ba2b4c22a13c55321e34443c386276; ?>
...
<?php endif; ?>
                <select name="role" id="role" class="w-50 form-control" required>
                    <option selected class="w-50" <?php echo e(old('role') == 'agent' ? 'selected' : ''); ?> value="agent">Agent
                    </option>
                </select>
            </div>
...
<?php endif; ?>
<?php /**PATH D:\DEVELOPMENT\pms\resources\views/auth/register.blade.php ENDPATH**/ ?>