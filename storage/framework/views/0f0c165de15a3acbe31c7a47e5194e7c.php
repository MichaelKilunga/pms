                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row border-top border-danger">
                                                    ...
                                                    <div class="d-flex">
                                                        <?php if($pharmacy->owner->ownerCurrentContract): ?>
                                                            <div class="row">
                                                                <div class="mb-3">
                                                                    <h5 class="text-primary">Name</h5>
...
<?php echo $__env->make('agent.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /media/michaelkilunga/C/SKYLINK/pms/resources/views/agent/pharmacies.blade.php ENDPATH**/ ?>