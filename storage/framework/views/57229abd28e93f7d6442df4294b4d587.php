    ...
    <body>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" name="email" required type="email" placeholder="john@example.com" />
                                </div>
                            </div>
                            ...
                            <div class="card-body p-4">
                                <div class="mb-4">
                                    <label class="form-label fw-bold text-secondary" for="systemItems">Number of Items
                                        / Medicines</label>
                                    <input class="form-control form-control-lg border-primary shadow-sm"
                                        id="systemItems" min="0" placeholder="e.g. 500" type="number">
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                const divisor =
                    <?php echo e(\App\Models\SystemSetting::where("key", "item_tier_divisor")->value("value") ?? 500); ?>;

                function calculatePrice(n, rate) {
                    if (!n || n < 0) return 0;
                    // Formula: max(1, floor(n/divisor)) * rate * n
                    let multiplier = Math.max(1, Math.floor(n / divisor));
                    return multiplier * rate * n;
                }
                ...
                // Stocking Price Calculator (Rate fixed at 200 for now or add to settings if needed)
                $('#stockingItems').on('input keyup change', function() {
                    let val = $(this).val();
                    let n = val ? parseInt(val) : 0;
                    let price = calculatePrice(n, 200);
