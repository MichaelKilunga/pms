<?php $__env->startSection('content'); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('hasrole', 'Agent')): ?>
        <h1 class="text-primary h4 mt-4 text-center">Registration Pannel</h1>
        <!-- Progress Bar -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($me && in_array($me->registration_status, ['step_1', 'incomplete', 'step_3'])): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($me == null || $me->registration_status == 'step_1'): ?>
            <div class="container mt-2">
                <div class="card shadow-lg">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('agent.completeRegistration')); ?>" enctype="multipart/form-data" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control required-field" id="country" name="country"
                                        ...
                                        value="<?php echo e(old('country', $agent->country ?? '')); ?>">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control required-field" id="NIN" name="NIN"
                                        ...
                                        value="<?php echo e(old('NIN', $agent->NIN ?? '')); ?>">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="required-field form-select" id="document_attachment_1_name"
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $compulsoryDocuments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option
                                                <?php echo e(old('document_attachment_1_name', $agent->document_attachment_1_name ?? '') == $option ? 'selected' : ''); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label class="form-label" for="agent_code">Agent Code: <span
                                            class="text-primary"><?php echo e(isset($agent_code) ? $agent_code : 'not assigned'); ?></span>
                                    </label>
                                    <br>
                                    <label class="form-label" for="agent_code">Verification Status: <span
                                            class="text-primary"><?php echo e(isset($agent_code) ? $agent_code : 'not verified'); ?></span>
                                    </label>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control required-field" id="address" name="address"
                                        placeholder="Tanzania, Morogoro, Morogoro municipal, Chief Kingalu market, A115." rows="2"><?php echo e(old('address', $agent->address ?? '')); ?></textarea>
        ...
        <?php elseif($me->registration_status == 'step_3'): ?>
                    ...
                    <div class="card-body text-start">
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <a class="btn btn-primary" href="<?php echo e(asset('storage/agreement_forms/agreement_form.pdf')); ?>"
                            ...
                            <div class="col-md-6">
                                <form action="<?php echo e(route('agent.completeRegistration')); ?>" enctype="multipart/form-data"
                                    id="uploadSignedAgreement" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <input hidden name="action" type="text" value="upload_agreement_form">
                                    
                                    <input hidden name="agent_id" type="text" value="<?php echo e($me->id); ?>">
        ...
        <?php elseif($me->registration_status == 'incomplete'): ?>
                    ...
                    <div class="card-body text-start">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($me->status == 'unverified'): ?>
                                    ...
                                    <div class="my-4 text-center">
                                        <a class="btn btn-primary"
                                            href="<?php echo e(route('agent.completeRegistration', ['action' => 'restart_steps'])); ?>">Re-Apply</a>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <?php elseif($me->registration_status == 'step_2'): ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($me->status == 'unverified'): ?>
                                    ...
                                    <div class="my-4 text-center">
                                        <a class="btn btn-danger"
                                            href="<?php echo e(route('agent.completeRegistration', ['action' => 'restart_steps'])); ?>"
                                            onclick="confirm('Are you sure you want to cancel?')">Cancel to Process</a>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($me->status == 'verified'): ?>
                                    
                                    <div class="my-4 text-center">
                                        <h1 class="h5 text-success"><i class="bi bi-person-check"> Verified!</i></h1>
                                        <a class="btn btn-primary"
                                            href="<?php echo e(route('agent.completeRegistration', ['action' => 'next_step'])); ?>">Next</a>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <?php elseif($me->registration_status == 'complete'): ?>
                    ...
                    <div class="card">
                        <h3 class="card-body row gap-3">
                            ...
                            <span class= "col-md-3">Verification Status: <span
                                    class="text-success fw-bold"><?php echo e($me->status); ?></span>
                            </span>

                            
                            <span class="col-md-4">Your Agent Code: <span
                                    class="text-<?php echo e($me->agent_code == null ? 'warning' : 'success fw-bold'); ?>"><?php echo e($me->agent_code ?? 'Waiting...'); ?></span>
                        </h3>
                    </div>
                </div>
            </center>
                        ...
                        <div class="col-md-12">
                            <p class="text-center">
                                ...
                                <a class="text-primary"
                                    href="mailto:<?php echo e(App\Models\User::where('role', 'super')->first()->email); ?>"><?php echo e(App\Models\User::where('role', 'super')->first()->email); ?></a>

                                <strong>Phone:</strong> <a class="text-success"
                                    href="tel:<?php echo e(App\Models\User::where('role', 'super')->first()->phone); ?>"><?php echo e(App\Models\User::where('role', 'super')->first()->phone); ?></a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    if (currentDocs < maxOptionalDocs) {
                        ...
                        <div class="col-md-6 mt-4">
                            ...
                            <select class="form-select optional-document" id="document_attachment_${docIndex}_name" name="document_attachment_${docIndex}_name">
                                ...
                                <?php $__currentLoopData = $optionalDocuments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <table class="table-bordered table-striped table" id="table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $agents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="small">
                                <td><?php echo e($agent->name); ?> <br> <span class="text-danger">
                                        <?php echo e($agent->isAgent && $agent->isAgent->agent_code != null ? 'Code: ' . $agent->isAgent->agent_code : ''); ?></span>
                                </td>
                                <td><?php echo e($agent->email); ?></td>
                                <td><?php echo e($agent->phone); ?></td>
                                <td><?php echo e($agent->isAgent != null ? $agent->isAgent->address : '-'); ?></td>
                                <td><?php echo e($agent->isAgent != null ? ($agent->isAgent->registration_status == 'incomplete' ? 'Rejected' : $agent->isAgent->status) : 'unverified'); ?>

                                </td>
                                <td>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($agent->isAgent != null): ?>
                                        
                                        <a href="<?php echo e(asset('storage/' . $agent->isAgent->document_attachment_1)); ?>"
                                            target="_blank">
                                            <small
                                                class="text-primary smallest"><?php echo e($agent->isAgent->document_attachment_1 ? $agent->isAgent->document_attachment_1_name : ''); ?></small>
                                        </a><br>
                                        <a href="<?php echo e(asset('storage/' . $agent->isAgent->signed_agreement_form)); ?>"
                                            target="_blank">
                                            <small
                                                class="text-primary smallest"><?php echo e($agent->isAgent->signed_agreement_form ? 'Agreement Form' : ''); ?></small>
                                        </a> <br>
                                        <a href="<?php echo e(asset('storage/' . $agent->isAgent->document_attachment_2)); ?>"
                                            target="_blank">
                                            <small
                                                class="text-primary smallest"><?php echo e($agent->isAgent->document_attachment_2 ? $agent->isAgent->document_attachment_2_name : ''); ?></small>
                                        </a> <br>
                                        <a href="<?php echo e(asset('storage/' . $agent->isAgent->document_attachment_3)); ?>"
                                            target="_blank">
                                            <small
                                                class="text-primary smallest"><?php echo e($agent->isAgent->document_attachment_3 ? $agent->isAgent->document_attachment_3_name : ''); ?></small>
                                        </a>
                                    <?php else: ?>
                                        N/A
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <td class="">
                                    <div class="d-flex justify-content-center">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($agent->isAgent != null): ?>
                                            <a class="<?php echo e($agent->isAgent->registration_status == 'step_2' ? '' : 'hidden'); ?> text-success"
                                                href="<?php echo e(route('agent.completeRegistration', ['action' => 'verify', 'set_status' => 'accepted', 'id' => $agent->isAgent->id])); ?>"><small
                                                    class="smallest"><i class="bi bi-check"> Verify</i></small></a> <br>
                                            <a class="<?php echo e($agent->isAgent->registration_status == 'step_2' ? '' : 'hidden'); ?> text-danger"
                                                href="<?php echo e(route('agent.completeRegistration', ['action' => 'verify', 'set_status' => 'rejected', 'id' => $agent->isAgent->id])); ?>"><small
                                                    class="smallest"><i class="bi bi-x"> Reject</i></small></a>
                                            <a class="<?php echo e($agent->isAgent->registration_status == 'complete' ? '' : 'hidden'); ?> <?php echo e($agent->isAgent->agent_code != null ? 'hidden' : ''); ?> text-primary"
                                                href="<?php echo e(route('agent.completeRegistration', ['action' => 'generateAgentCode', 'id' => $agent->isAgent->id])); ?>"><small
...
<?php echo $__env->make('agent.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DEVELOPMENT\pms\resources\views/agent/complete.blade.php ENDPATH**/ ?>