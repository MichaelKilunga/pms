<?php $__env->startSection("content"); ?>
    <div class="container mt-4">
        <?php if(Auth::user()->unreadNotifications->count() == 0 && Auth::user()->notifications->count() == 0): ?>
                ...
                <?php $__currentLoopData = Auth::user()->notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        ...
                        <div class="me-auto ms-2">
                            ...
                            <?php if(isset($notification->data["action_url"]) || isset($notification->data["action"])): ?>
...
<?php echo $__env->make("notifications.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /media/michaelkilunga/C/SKYLINK/pms/resources/views/notifications/index.blade.php ENDPATH**/ ?>