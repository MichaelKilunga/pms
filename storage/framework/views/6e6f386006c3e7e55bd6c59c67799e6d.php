                    ...
                    <form id="createConversationForm">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="conversationParticipants" multiple name="recipients[]"
                                required size="5">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $potentialRecipients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadConversations() {
                $.get("<?php echo e(route('messages.conversations')); ?>", function(data) {
                    if (data.success) {
            ...
            $("#createConversationForm").on('submit', function(e) {
                ...
                $.post("<?php echo e(route('messages.create')); ?>", data, function(response) {
                    if (response.success) {
...
<?php echo $__env->make('agent.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DEVELOPMENT\pms\resources\views/agent/messages.blade.php ENDPATH**/ ?>