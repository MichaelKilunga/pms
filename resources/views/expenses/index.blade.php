                                        ...
                                        <div class="modal-body">
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item"><strong>Description:</strong> <span
                                                        id="modal-description"></span> {{ $expense->description ?? '-' }}
                                                </li>
                                            ...
                                            <div class="modal-body">
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="date" name="expense_date" id="edit-expense-date"
                                                            class="form-control"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="vendor_id" id="edit-vendor" class="form-select">
