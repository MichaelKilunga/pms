                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div><strong>Low stock percentage:</strong> {{ $stock->low_stock_percentage }}%</div>
                                        ...
                                        <form action="{{ route('stock.update', $stock->id) }}" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" name="remain_Quantity"
                                                    value="{{ $stock->remain_Quantity }}" required title="You cannot edit">
                                            </div>
                                            <div class="mb-3">
                                                <label for="quantity" class="form-label">Low stock percentage(%)</label>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" name="in_date"
                                                    value="{{ $stock->created_at }}" required>
                                            </div>
                                            <div class="mb-3">
                    ...
                    <div id="stockFields">
                        <div class="row mb-3 stock-entry align-items-end gx-2 gy-2">
                            ...
                            <div class="col-0 col-sm-0 col-md-0 col-lg-0" hidden>
                                ...
                                <input type="text" class="form-control shadow-sm" name="in_date[]" value="{{ now() }}" required>
                            </div>
                            <div class="col-12 col-sm-6 col-md-4 col-lg-2">
